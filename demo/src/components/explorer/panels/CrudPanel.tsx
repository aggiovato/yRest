  ...
  return (
    <>
      <p className="feature-desc">
        Full CRUD auto-generated from <code>db.yml</code>: <code>GET /api/todos</code>,{" "}
        <code>POST /api/todos</code>, <code>PATCH /api/todos/:id</code>,{" "}
        <code>DELETE /api/todos/:id</code>. Operations here and in the to-do list both update this
        log and reflect in the UI.
      </p>
      ...
      <ApiLog
        log={state.crudLog}
        emptyMessage="Perform an operation in the todo list or test here..."
      />
    </>
  );
}
