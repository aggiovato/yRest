...
export function SortPagePanel() {
  ...
  async function handleTry() {
    ...
    setLog({ method: 'GET', url: r.url, status: r.status, data: r.data, total: r.total, ts: Date.now() });
  }

  return (
    <>
      <p className="feature-desc">
        Sort with <code>?_sort=field&amp;_order=asc|desc</code>.
        Paginate with <code>?_page=N&amp;_limit=N</code>.
        The <code>X-Total-Count</code> header returns the unpaginated total.
      </p>
