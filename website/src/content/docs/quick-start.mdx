...
If you want to embed yRest inside a test suite (Vitest, Playwright, Cypress), see [Programmatic API](/programmatic-api/) instead.
:::
...
- [Configuration](/configuration/) — all `yrest.config.yml` options
