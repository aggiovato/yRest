...
import quickSteps from "../../../assets/quick-steps.png";
...
<div class="yr-quick-steps-wrap">
  <Image src={quickSteps} alt="yRest in 4 steps: install, define, serve, use" width={480} />
</div>
